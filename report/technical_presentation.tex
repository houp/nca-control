...
Seed \(4\) large-grid & \(100,200\) & \(1.0\) \\
Seed \(1\) large-grid & \(100,200\) & \(1.0\) \\
\bottomrule
\end{tabular}
\end{block}
...
\small
Exact rollout checks remained valid up to \(200\times 200\), including seed \(4\).
\end{alertblock}
\end{columns}
\end{frame}
...
\begin{itemize}
  \item the old seed-\(4\) failure is not reproduced under the stronger recipe
