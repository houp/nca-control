...
The repository retains both a PyTorch implementation and an MLX implementation. PyTorch remains useful for CPU execution and for an experimental CUDA-enabled path intended for collaborators running Linux on NVIDIA hardware, while MLX is currently the preferred Apple Silicon backend. The implementation also includes:
\begin{itemize}
